...
ob_end_clean();
$buffer=str_replace("%TITLE%","Produktfördelar | EZ Street New Zealand kall asfalt",$buffer);
$buffer=str_replace("%DESCRIPTION%","",$buffer);
$buffer=str_replace("%KEYWORDS%","potthål reparation, asfalt reparation, produktfördelar",$buffer);
echo $buffer;
?>
	...
	<div class="container productlist">
		<div class="row">
            ...
            <div class="col-lg-12 remove-padding">
                <h1>Produktfördelar</h1>
                <ol class="breadcrumb">
                    <li><a href="/mobile/">Hem</a></li>
                    <li class="active">Produkt</li>
                    <li class="active">Produktfördelar</li>
                </ol>
            </div>
...
<script>
  $(document).ready(function () {
        ...
        $('.product-benefits').addClass('active');
    });
</script>